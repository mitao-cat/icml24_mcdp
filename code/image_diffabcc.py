...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="diffabcc", help="Model type")
    ...
    fair_criterion = CDFdpTS(args.temperature)
    optimizer = optim.Adam(net.parameters(), lr = args.lr)
    scheduler = StepLR(optimizer, step_size=50, gamma=0.1)

    print(net)

    if args.target_attr == 'Attractive':
        subdir = 'celeba-a'
    elif args.target_attr == 'Wavy_Hair':
        subdir = 'celeba-w'
